...
import { Plus, Search, BookOpen, Target, Users } from 'lucide-react';
      ...
      <div className="text-center py-12">
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-400 mb-8 max-w-2xl mx-auto">
            Get started by creating your first scenario, building AI characters, or exploring what others have built. 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="bg-slate-800 border-slate-700 hover:bg-slate-800/80 transition-all duration-200 cursor-pointer group"
            ...
            <CardContent className="p-6 text-center">
              <div className="w-12 h-12 bg-amber-400/20 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                <Users className="w-6 h-6 text-amber-400" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Create Character</h3>
              <p className="text-slate-400 text-sm">
                Design AI characters with unique personalities and expertise
              </p>
            </CardContent>
          </Card>
