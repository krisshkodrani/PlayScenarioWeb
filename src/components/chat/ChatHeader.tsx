      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link
            ...
            className="min-w-[44px] min-h-[44px] px-3 py-2 rounded-lg border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-slate-900 transition-all duration-200 flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-slate-900"
          >
            <ArrowLeft className="w-5 h-5" />
            <span className="hidden sm:inline font-medium uppercase tracking-wide">Dashboard</span>
          </Link>
