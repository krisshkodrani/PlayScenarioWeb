...
const ScenarioHero: React.FC<ScenarioHeroProps> = ({ scenario }) => {
  ...
  return (
    <Card className="overflow-hidden bg-gradient-to-br from-slate-800/90 to-slate-700/50 border-slate-600 backdrop-blur">
      {/* Featured Image */}
      {scenario.featured_image_url && (
        <div className="aspect-video md:aspect-[21/9] w-full bg-slate-900 overflow-hidden relative">
          <img
      ...
      <div className="p-8 space-y-6">
        {/* Title and Badges for scenarios without featured image */}
        {!scenario.featured_image_url && (
          <div className="space-y-4">
            ...
            {/* Key Metadata for scenarios without featured image */}
