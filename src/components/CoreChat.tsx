...
const CoreChatInner: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      {/* Header with Title and Floating Indicators */}
      <div className="relative bg-gradient-to-r from-slate-800/80 to-slate-700/50 backdrop-blur border-b border-slate-600 p-4">
        <h1 className="text-lg font-semibold text-cyan-400">Kobayashi Maru Simulation</h1>
        
        {/* Floating Indicators - positioned relative to header */}
